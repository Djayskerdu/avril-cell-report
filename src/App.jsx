...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxlwelJ7TvGQKbHEQumKkn8BwLt86mdbDRj15A9ksmoD75ii82pvm0LK5CEy5JjAofW/exec";
  ...
  return (
    <div className="home-wrap">
      <div className="home-hero">
        <span className="eyebrow">Avril Lee Laparan's Cell Report</span>
    ...
    <div className="shell" data-textsize={textSize}>
      ...
      <header className="topbar">
        <button className="brand" onClick={goHome}>
          ...
          <span className="brand-name">Avril Lee Laparan's Cell Report</span>
        </button>
